...
*  =======
*
*  PSAMAX  computes the global index of the maximum element in  absolute
...
*/
   ...
   if( !( info = ( ( nprow == -1 ) ? -( 701 + CTXT_ ) : 0 ) ) )
      PB_Cchkvec( ctxt, "PSAMAX", "X", *N, 1, Xi, Xj, Xd, *INCX, 7, &info );
   if( info ) { PB_Cabort( ctxt, "PSAMAX", info ); return; }
#endif
/*
...
l_10:
               if( mydist & 1 )
               {
                  ...
                  Csgesd2d( ctxt, 2, 1, ((char*)work), 2, myrow, dst );
                  goto l_20;
               }
               else
               {
                  ...
                  if( mycol < src )
                  {
                     Csgerv2d( ctxt, 2, 1, ((char*) &work[2]), 2, myrow,
                               src );
...
*/
               ...
               if( mycol == 0 )
               {
                  Csgebs2d( ctxt, ROW, &rbtop, 2, 1, ((char*)work), 2 );
               }
               else
               {
                  Csgebr2d( ctxt, ROW, &rbtop, 2, 1, ((char*)work), 2,
                            myrow, 0 );
               }
            }
/*
...
*  distributed
*/
               Csgamx2d( ctxt, ROW, &rctop, 1, 1, ((char*)AMAX), 1,
...
l_30:
               if( mydist & 1 )
               {
                  ...
                  Csgesd2d( ctxt, 2, 1, ((char*)work), 2, dst, mycol );
                  goto l_40;
               }
               else
               {
                  ...
                  if( myrow < src )
                  {
                     Csgerv2d( ctxt, 2, 1, ((char*) &work[2]), 2,
                               src, mycol );
                     if( ABS( work[0] ) < ABS( work[2] ) )
                     { work[0] = work[2]; work[1] = work[3]; }
                  }
...
*/
               ...
               if( myrow == 0 )
               {
                  Csgebs2d( ctxt, COLUMN, &cbtop, 2, 1, ((char*)work), 2 );
               }
               else
               {
                  Csgebr2d( ctxt, COLUMN, &cbtop, 2, 1, ((char*)work), 2,
                            0, mycol );
               }
            }
/*
...
*  distributed.
*/
               Csgamx2d( ctxt, COLUMN, &cctop, 1, 1, ((char*)AMAX), 1,
