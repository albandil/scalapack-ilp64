...
*  =======
*
*  PSASUM returns the sum of absolute values of the entries of a subvec-
*  tor sub( X ),
*
*  where
*
...
*/
   ...
   if( !( info = ( ( nprow == -1 ) ? -( 601 + CTXT_ ) : 0 ) ) )
      PB_Cchkvec( ctxt, "PSASUM", "X", *N, 1, Xi, Xj, Xd, *INCX, 6, &info );
   if( info ) { PB_Cabort( ctxt, "PSASUM", info ); return; }
#endif
/*
*  Initialize ASUM
*/
...
*/
            ...
            Csgsum2d( ctxt, ROW, &top, 1, 1, ((char *)ASUM), 1, -1,
                      mycol );
         }
      }
      return;
...
*/
            ...
            Csgsum2d( ctxt, COLUMN, &top, 1, 1, ((char *)ASUM), 1, -1,
                      mycol );
         }
      }
      return;
